---
id: stakeholder-competitive-briefing
name: Stakeholder Competitive Briefing
domain: rs-competitive
version: 1.0.0
---

# Stakeholder Competitive Briefing

**Purpose:** Master stakeholder competitive briefing as a research discipline — the specific methods, frameworks, and judgment calls that produce reliable insights and confident decisions.

Stakeholder Competitive Briefing is where research becomes craft. The difference between a study that produces "interesting findings" and one that changes a $10M product decision is the practitioner's skill in designing the approach, executing the method, and synthesizing the results into action.

## The Core Framework

Effective stakeholder competitive briefing requires three capabilities working together:
...
### The CI Collection Framework
**Public sources (highest volume):** Website/product, job postings (reveal priorities), press releases, SEC filings, patent filings, earnings calls, social media.

**Customer sources (highest quality):** Win/loss interviews, customer reviews (G2, Capterra), support forums, advisory board discussions.

**Industry sources (strategic context):** Analyst reports (Gartner, Forrester), conferences, expert networks.

### The Win/Loss Analysis System
**Protocol:** Interview within 30 days of close. Decision-maker, not champion. Questions: What prompted evaluation? Who else considered? Top 3 criteria? Strengths/weaknesses of each? Deciding factor? What would change your decision?

**Sample:** 10 wins + 10 losses per quarter minimum. Stratify by deal size, industry, competitor, sales rep.

**Analysis:** Win themes (what consistently appears in wins), loss themes (what appears in losses), competitor-specific patterns (how you perform against each).

**Action:** Win themes -> reinforce in messaging. Loss themes -> product roadmap + positioning. Competitor patterns -> battle cards.

### Case Study: How Salesforce Built a CI Machine
Every deal tagged with competitive landscape. Dedicated CI team monitors weekly. Battle cards updated monthly from win/loss data. Quarterly war games simulate competitor moves. CI embedded in the sales process, not a separate function.

### The Battle Card Architecture
**Quick overview (2 sentences).** Who they are, where they compete.

**Strengths (3-5 bullets).** What they're genuinely good at. Honesty builds rep credibility.

**Weaknesses (3-5 bullets).** From customer feedback and reviews. Specific, evidence-based, tied to buyer pain.

**Landmines (3-5 questions).** Questions that highlight competitor weaknesses: "How important is real-time reporting without analyst configuration?"

**Objection counters (top 5).** Acknowledge -> Reframe -> Differentiate.

**Proof points (3-5).** Customer quotes and case studies that specifically counter competitor positioning.

### The Competitive Monitoring System
**Signal detection.** Job postings (strategic direction), patent filings (R&D priorities), executive social media (positioning shifts), customer reviews (product quality trends), pricing changes (market strategy), partnerships (ecosystem expansion).

**The early warning system.** Weekly automated alerts on: competitor mentions, executive statements, product launches, funding events, hiring surges in specific functions. Monthly synthesis: what do the signals collectively suggest about each competitor's direction?

**The intelligence brief.** Monthly 1-page brief per major competitor: what changed, what it means, what we should do. Distributed to sales, product, marketing, and executive teams. The brief is the delivery mechanism — raw signals without interpretation are noise.

### The Strategic Group Mapping Method
Map competitors by strategic dimensions relevant to your market:

**Dimension selection.** Choose 2 dimensions your buyers care about most: price vs features, specialization vs breadth, self-serve vs enterprise, innovation vs reliability. Map every competitor on the 2x2.

**Cluster identification.** Competitors clustered together compete directly. Competitors in empty quadrants represent potential positioning opportunities.

**Movement analysis.** Track where competitors move over time. A competitor moving from "low-price/basic-features" toward "mid-price/advanced-features" is coming after your market position. The movement IS the competitive threat.

### The Pricing Intelligence Framework
**Published pricing analysis.** Document every competitor's published pricing: tiers, features per tier, per-seat costs, usage limits. Create a comparison matrix.

**Actual pricing discovery.** Published prices rarely reflect actual deal prices. Sources: win/loss interviews ("what was their final offer?"), customer reviews mentioning pricing, job listings for pricing/packaging roles (signals pricing experimentation), analyst reports.

**Price positioning decision.** Based on competitive pricing landscape: price above (signals premium, requires clear differentiation), price at parity (competes on features/experience), price below (signals accessibility, requires cost efficiency).





### The Competitive Product Teardown Method
Systematically analyzing a competitor's product:

**The functional teardown.** Sign up for the competitor's product. Complete 10 core tasks. Document: how many steps each task takes, where you get confused, what features are missing, what features are excellent. Screenshot every screen. This creates an evidence-based competitive analysis, not an opinion-based one.

**The experience teardown.** Evaluate the full experience: marketing site, signup flow, onboarding, core product, support interaction, billing/cancellation. Rate each touchpoint on a 5-point scale. The competitor's weakest touchpoint is your differentiation opportunity.

**The pricing teardown.** Understand the competitor's pricing model: what's included at each tier, what the upgrade triggers are, what the pricing psychology is (monthly vs annual default, feature gating vs usage gating). How does their model constrain or enable certain customer segments?

**The messaging teardown.** Capture: their homepage headline, their value proposition, their top 3 claims, their proof points, their target audience language. Map their positioning: who do they say they're for? What do they say they're best at? Where are they vulnerable (claims without proof, segments they don't address)?

### The Market Share Estimation Technique
When official market share data doesn't exist (most markets):

**The proxy method.** Use observable proxies: website traffic (SimilarWeb), employee count (LinkedIn), job postings (indicator of growth), social media following, app downloads (for mobile products), G2/Capterra review count (indicator of customer base size). No proxy is perfect, but 3-4 proxies together provide a reasonable estimate.

**The build-up method.** Estimate each competitor's customer count and ARPU: Customer count from: logos on their website, case studies, review count (typically 1 review per 100-200 customers), employee count / typical employees-per-customer ratio. ARPU from: published pricing, win/loss interviews, analyst reports. Revenue estimate = customer count x ARPU. Market share = competitor revenue / TAM.




### The Competitive Early Warning System
Detecting competitive threats before they materialize:

**Weak signals to monitor.** (1) Hiring patterns — a competitor hiring ML engineers signals AI investment 12-18 months before product launch. (2) Patent filings — reveal R&D direction years before products ship. (3) Executive social media — tone shifts and topic changes signal strategic pivots. (4) Customer community chatter — users discussing switching signals satisfaction decline. (5) Partnership announcements — new partnerships reveal market expansion plans.

**The signal aggregation cadence.** Daily: automated alerts on competitor mentions, executive posts, job listings. Weekly: review aggregated signals, flag significant patterns. Monthly: synthesize weekly patterns into competitive narrative. Quarterly: strategic assessment — what do accumulated signals mean for our positioning?

**The threat assessment matrix.** For each detected signal: (1) Probability (how likely is this actually happening? 1-5). (2) Impact (if it happens, how much does it affect us? 1-5). (3) Timeframe (when would we feel the impact? 1-5 where 5 = imminent). Probability x Impact x Timeframe urgency = threat priority score. Focus response on the top 3.

### The Competitive Narrative Analysis
Understanding how competitors frame themselves:

**Message deconstruction.** For each competitor's homepage: What's the headline promise? What proof do they offer? What objections do they preemptively address? What do they NOT mention? The absence is often as revealing as the presence — competitors avoid topics where they're weak.

**The positioning map evolution.** Track competitor messaging quarterly. Plot changes: are they moving upmarket (more enterprise language)? Expanding scope (adding capabilities to their claims)? Narrowing focus (becoming more specialized)? The trajectory reveals strategy more clearly than any single snapshot.
...
When stakeholder competitive briefing is the right method for the research question at hand. When decision stakes are high enough to justify the investment. When existing data is insufficient and new evidence is needed. When the team is operating on assumptions that haven't been validated.
