---
id: category-creation-research
name: Category Creation Research
domain: rs-market
version: 1.0.0
---

# Category Creation Research

**Purpose:** Master category creation research as a research discipline — the specific methods, frameworks, and judgment calls that produce reliable insights and confident decisions.

Category Creation Research is where research becomes craft. The difference between a study that produces "interesting findings" and one that changes a $10M product decision is the practitioner's skill in designing the approach, executing the method, and synthesizing the results into action.

## The Core Framework

Effective category creation research requires three capabilities working together:
...
## The Market Research Operating System

### The Market Sizing Discipline
Market sizing is the most common research exercise and the most commonly botched:

**Top-down sizing** starts with a large known number and narrows: total industry revenue -> segment addressable -> portion capturable. Example: "Global CRM market $80B (Gartner). Mid-market (50-500 employees) = 30% = $24B. Cloud-native = 40% = $9.6B. North America (45%) = $4.3B TAM." Fast, useful for order-of-magnitude, but relies on third-party categorization that may not match your actual market.

**Bottom-up sizing** builds from unit economics: number of potential customers x average revenue per customer = TAM. Example: "285,000 mid-market companies in NA (Census). 60% use CRM = 171,000. Average annual spend $25K. TAM = $4.275B." More defensible because built from observable data. Only as accurate as your assumptions about customer count and willingness to pay.

**The triangulation rule:** Always calculate both. Within 2x = credible. More than 3x apart = wrong assumption somewhere. Present both to stakeholders.

### The Segmentation Framework
Markets are not monoliths. Segmentation reveals where opportunity lives:

**Needs-based segmentation** (most useful): group by the problem they solve, not demographics. Two same-sized companies may have completely different needs. Predicts buying behavior more accurately than firmographics.

**Behavioral segmentation** (most predictive): group by how prospects behave — where they search, how they evaluate, how fast they decide. Informs channel strategy and sales motion.

**Value-based segmentation** (most strategic): group by LTV potential. Which segments generate most revenue, retain longest, expand most? Determines where to invest acquisition dollars for maximum ROI.

### Case Study: How Figma Sized a Market That Didn't Exist
Figma couldn't use existing categories — "collaborative design tool in the browser" wasn't recognized. Their approach: count professional designers (~15M) x collaborative percentage (~70%) x willingness to pay ($15/mo) = $1.89B. Then expanded definition beyond designers to include PMs, devs, marketers — 5x the TAM to ~$10B. The lesson: when creating a category, you must define the market before sizing it. The definition IS the strategy.

### The Trend Analysis Method
**Signal strength assessment.** For each trend: (1) Multiple independent confirming sources. (2) Observable behavior changes (not just attitudes). (3) Investment flows (VC, R&D, government spending). (4) Regulatory movement. A trend confirmed on 3+ dimensions is strong. One dimension = speculation.

**Timing assessment.** Right trend, wrong timing = wrong. Evaluate: infrastructure readiness, behavior readiness, economic readiness. All three must be ready.

**3-horizon model.** H1 (0-12 months): trends already impacting. Respond. H2 (12-36 months): building momentum. Invest in learning. H3 (36+ months): conceptually real, practically distant. Monitor only.

### The Primary Research Protocol for Markets
**Expert interviews (10-15).** Industry analysts, former executives, consultants, investors. Questions: biggest unmet need, market direction 3-5 years, emerging players, what would change with magic wand. Fastest way to develop market intuition.

**Customer interviews (20-30).** Current customers, competitor customers, non-consumers. How they solve the problem today, frustrations, what would make them switch, current spend.

**Synthesis:** Top 5 unmet needs ranked by frequency/intensity. Top 3 decision criteria. Market map with gaps. Sizing validation. The synthesis is the deliverable.

### The Market Intelligence System
Building ongoing market awareness vs one-off studies:

**Weekly signals.** Google Alerts on competitors, industry keywords, key executives. Track: product launches, funding announcements, executive hires, partnership deals. 15 minutes per day scanning.

**Monthly analysis.** Aggregate weekly signals into patterns. Which competitors are moving upmarket? Which are expanding geographically? Where is VC money flowing? Monthly patterns reveal strategic shifts invisible in weekly noise.

**Quarterly deep-dive.** Full competitive landscape update. Customer segment analysis. Pricing benchmarking. Trend assessment. The quarterly deep-dive feeds strategic planning.

### The Market Research Presentation Framework
Present market research for decision-making, not for education:

**The executive summary (1 slide).** The market opportunity in one sentence. The recommended action. The key risk. Everything the decision-maker needs in 30 seconds.

**The evidence (3-5 slides).** Market size with methodology. Segmentation with opportunity ranking. Trend analysis with timing assessment. Competitive landscape with positioning implications. Each slide = one finding + the evidence + the implication.

**The recommendation (1 slide).** Based on evidence: here's what we should do, here's what it requires, here's the expected outcome, here's the risk. Decision-ready.

**The appendix (as many slides as needed).** Detailed methodology, full data tables, interview quotes, calculation worksheets. For the deep-divers, not the presentation.





### The Competitive Pricing Research Method
Pricing is the most under-researched element in most go-to-market strategies:

**The 4-method approach.** (1) Van Westendorp (survey-based price sensitivity — reveals acceptable range). (2) Gabor-Granger (sequential price testing — reveals demand at each price point). (3) Conjoint (trade-off analysis — reveals how much each feature contributes to willingness-to-pay). (4) Competitive benchmarking (observed prices — reveals market expectations). Use at least 2 methods and triangulate. No single pricing method is reliable alone.

**The implementation.** Run Van Westendorp with 200+ responses from your target segment. The "point of marginal cheapness" (too cheap to trust) and "point of marginal expensiveness" (too expensive to consider) define the boundaries. The "indifference price point" (equal number saying bargain and expensive) is the market's expected price. Price above this for premium positioning, at it for competitive positioning, below for penetration.

### The Secondary Research Efficiency System
Before investing in primary research, exhaust secondary sources:

**Tier 1 — Free, immediate.** Google Scholar, industry association reports, government data (Census Bureau, BLS, Federal Reserve), SEC filings, company press releases, Crunchbase, LinkedIn Sales Navigator demographics.

**Tier 2 — Paid, fast.** Analyst reports (Gartner, Forrester, IDC — $2-5K per report), data aggregators (Statista, IBISWorld — $500-2K/year), financial databases (PitchBook, CB Insights — $5-15K/year).

**Tier 3 — Custom, slow.** Commission custom research from firms (McKinsey, Bain — $50-200K), expert networks (GLG, AlphaSights — $500-1,500/hour), custom surveys ($5-50K depending on sample and methodology).

**The rule:** Never pay for Tier 2 or 3 until Tier 1 is exhausted. 60-70% of market research questions can be answered with freely available data plus structured analysis. The remaining 30-40% justify the investment in primary research because the secondary data is insufficient.




### The Market Entry Decision Framework
When evaluating whether to enter a new market:

**Attractiveness score (5 dimensions, 1-5 each).** (1) Market size (TAM > $1B = 5, < $100M = 1). (2) Growth rate (> 20% CAGR = 5, < 5% = 1). (3) Competition intensity (fragmented = 5, dominated by 2-3 players = 1). (4) Customer accessibility (direct channels available = 5, requires intermediaries = 1). (5) Regulatory clarity (clear and favorable = 5, uncertain or restrictive = 1). Total > 20 = highly attractive. < 12 = avoid.

**Readiness score (4 dimensions, 1-5 each).** (1) Product-market fit potential (strong evidence from adjacent market = 5, speculation = 1). (2) Team capability (relevant domain expertise = 5, none = 1). (3) Distribution advantage (existing channel reaches new market = 5, must build from scratch = 1). (4) Financial capacity (can sustain 18-month runway = 5, < 6 months = 1). Total > 16 = ready. < 10 = not yet.

**The decision.** Attractive + Ready = Enter. Attractive + Not Ready = Prepare (build capability, then enter). Not Attractive = Skip regardless of readiness.

### The Jobs-to-be-Done Market Research Method
Markets defined by jobs, not demographics:

**The job definition.** A job is the progress a person is trying to make in a specific circumstance. "Help me feel confident presenting data to my board" — not "give me a dashboard tool." The job is the demand. The product is the supply.

**The job map (8 universal steps).** (1) Define the goal. (2) Locate inputs. (3) Prepare. (4) Confirm readiness. (5) Execute. (6) Monitor. (7) Modify. (8) Conclude. Map your market's job through these steps. At each step: what is the customer trying to do? What frustrates them? Where do they waste time? Where do they make mistakes? The frustration points are the opportunities.

**The competitive analysis through JTBD.** Competitors aren't just direct substitutes — they're any solution the customer uses to make progress on the same job. The competitor to a CRM isn't just other CRMs — it's spreadsheets, sticky notes, memory, and "just winging it." The full competitive set is often 10x larger than the direct competitor set.
...
When category creation research is the right method for the research question at hand. When decision stakes are high enough to justify the investment. When existing data is insufficient and new evidence is needed. When the team is operating on assumptions that haven't been validated.
