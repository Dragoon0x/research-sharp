---
id: customer-advisory-board-research
name: Customer Advisory Board Research
domain: rs-user
version: 1.0.0
---
...
**Purpose:** Master customer advisory board research as a research discipline — the specific methods, frameworks, and judgment calls that produce reliable insights and confident decisions.

Customer Advisory Board Research is where research becomes craft. The difference between a study that produces "interesting findings" and one that changes a $10M product decision is the practitioner's skill in designing the approach, executing the method, and synthesizing the results into action.

## The Core Framework

Effective customer advisory board research requires three capabilities working together:
...
## The User Research Operating System

### The Research Method Selection Matrix
**Discovery (what should we build?):** User interviews (8-15, 45-60 min) — understanding needs and motivations. Contextual inquiry — real workflow observation. Diary studies (1-4 weeks) — patterns over time. JTBD interviews — causal mechanisms behind adoption.

**Evaluation (does this work?):** Usability testing (5-8, task-based) — specific usability problems. A/B testing — which version performs better. First-click testing — navigation evaluation. Unmoderated testing — volume and geographic diversity.

**Strategic (where should we focus?):** Journey mapping — highest-leverage moments. Competitive UX audit — conventions and differentiation. Analytics review — actual behavior at scale.

### The Interview Mastery Framework
**The warm-up (5 min).** Build rapport. Ask about role, day, context. Make them comfortable enough to be honest.

**The story elicitation (25-30 min).** Don't ask opinions — ask for stories. "Tell me about the last time you tried to [task]." Stories reveal: what happened, emotions, workarounds, and decision criteria. Probe with: "What happened next?" "How did that make you feel?" "Why did you choose that approach?"

**Probing hierarchy:** Echo probe (repeat their words as question). Silence probe (wait 5-7 seconds). Why probe (limit to 2-3). Contrast probe ("How does that compare to...?"). Projection probe ("If you could change one thing...").

**The closing.** "Is there anything I should have asked but didn't?" — consistently produces the most valuable insights.

### Case Study: How Airbnb's Research Transformed the Business
In 2009, bookings were flat. The team flew to New York, visited hosts. Discovered: listing photos were terrible. Hired professional photographers, offered free shoots. Listings with pro photos booked 2.5x more. The insight came from contextual inquiry — going to the user's context and seeing the problem firsthand. Analytics showed low conversion but not why. Surveys wouldn't have caught it — hosts thought their photos were fine.

### The Synthesis-to-Insight Pipeline
**Step 1 — Extract observations.** 15-25 per session. Format: "[Participant] [did/said] [specific thing] [in context]." Specific — not interpretive.

**Step 2 — Affinity clustering.** Group related observations. Let clusters emerge from data. 8-15 clusters from 8-12 interviews.

**Step 3 — Write insight statements.** "[User segment] needs [need] because [motivation], but currently [barrier], which results in [consequence]."

**Step 4 — Prioritize by impact.** Score each: frequency (how many mentioned), severity (how much it affected them), addressability (can we fix this). The intersection is where highest-impact decisions live.

### The Persona Development Method
**Data-driven.** Built from research data, not workshop assumptions. A persona without supporting data is a stereotype.

**Behavioral dimensions.** Not demographics — goals, workflows, pain points, decision criteria, context. Two same-demographic users may have completely different needs.

**Validation.** Present to sales, support, CS: "Do you recognize these people?" If frontline teams don't recognize them, go back to the data.

### The Research Repository System
Every study produces a nugget: research question, method, key findings, evidence, implications. Searchable by topic, date, method, product area. Before starting new research, check the repository — the answer may already exist. The repository is compound interest for the research function.

### The Usability Testing Protocol (Deep)
**Recruiting:** 5-8 per round. Match actual user profile. Screen for relevant experience, no prior exposure (unless testing existing users). Comfortable thinking aloud.

**Task design:** 5-7 tasks. Describe goals, not procedures. "Find a project management tool for a 15-person team" — not "Click Products, then Teams." Easy to hard ordering builds confidence.

**Moderation:** 80/20 listening. "What are you looking for?" "What do you think that does?" Never defend the design. Never guide. You're there to learn.

**Analysis:** Watch every recording. Note: hesitation, confusion, wrong paths, delight, smooth completion. Group into: critical (task failure), major (significant difficulty), minor (slight friction), positive (working well).





### The Remote Research Adaptation Framework
Remote research isn't just in-person research over video — it requires specific adaptations:

**Screen sharing setup.** Ask participants to share their screen BEFORE the session starts. Walk them through technical setup 5 minutes early. 10% of remote sessions have technical issues — plan for it with backup options (phone call + screen recording on their end).

**The energy management problem.** Remote sessions are more fatiguing than in-person. Limit to 45 minutes (vs 60 in-person). Build in a 2-minute break at the midpoint. Use more visual stimuli (show prototypes, share images) to maintain engagement.

**The observation limitation.** You can't see their full body language over video. Compensate by: asking more about emotional reactions ("How did that make you feel?"), watching micro-expressions more carefully (the face is all you have), and using more think-aloud prompts ("Tell me what you're thinking right now").

**The asynchronous option.** Unmoderated studies (UserTesting, Maze) let participants complete tasks on their own time. 5x the throughput of moderated sessions. Use for: usability testing (task success/failure), first-click testing, preference testing. Don't use for: discovery (no ability to probe), complex scenarios (no moderator to guide), or emotionally sensitive topics (no rapport).

### The Longitudinal Research Design
When you need to track change over time:

**Diary studies.** Participants log experiences daily for 1-4 weeks. Captures real-time context that retrospective interviews miss. The diary should be easy (2-3 min per entry) using the participant's preferred method (app, voice memo, text message). Expect 60-70% completion rate. Brief each participant individually and send daily reminders.

**Panel studies.** Interview the same participants at multiple points (month 1, month 3, month 6). Reveals how attitudes and behaviors evolve. Requires: participant retention strategy (incentives, relationship management), consistent interview protocol across waves, and analysis that tracks individual change rather than just aggregate snapshots.
...
**Informed consent.** Participants must understand: what the study involves, how their data will be used, that participation is voluntary, and that they can withdraw at any time without consequence. Written consent for in-person. Click-through consent for remote. Never record without explicit permission.

**Data privacy.** Anonymize participant data in analysis and reporting. Use participant codes (P1, P2), not names. Store raw data (recordings, transcripts) securely with access restricted to the research team. Delete raw data after the project is complete (retain only anonymized insights). Comply with applicable regulations (GDPR, CCPA).

**Participant wellbeing.** If the research topic is sensitive (health, finances, trauma), provide: content warnings before the session, the option to skip any question, and links to relevant support resources. Never push a participant to discuss something they're uncomfortable with.

**The incentive ethics.** Incentives should compensate for time, not coerce participation. Standard: $75-150/hour for consumer research, $200-500/hour for professional/expert research. The incentive should not be so large that participants who don't qualify fabricate eligibility.

### The Behavioral Analytics Integration
Combining qualitative research with quantitative behavioral data:

**Before qualitative research.** Pull analytics to identify: where users drop off (funnel analysis), which features are used and which are ignored (feature usage), what paths users take (flow analysis), and where users spend time (engagement mapping). These patterns become hypotheses for the qualitative study: "We see 40% drop-off at step 3 — interviews should explore why."

**During qualitative research.** If studying a specific flow: share the participant's own analytics (with permission) during the interview. "I can see you used feature X 14 times but never used feature Y. Can you tell me about that?" Behavioral data makes the conversation specific and productive.

**After qualitative research.** Validate qualitative findings quantitatively. If 6 of 8 interviewees said "I can't find the export button," check: what percentage of all users attempt export? Of those, what percentage succeed? The quantitative validation transforms a qualitative observation into a sized business case.
...
When customer advisory board research is the right method for the research question at hand. When decision stakes are high enough to justify the investment. When existing data is insufficient and new evidence is needed. When the team is operating on assumptions that haven't been validated.
